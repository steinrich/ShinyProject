...
Raw Data
	The raw data is accelerometer data collected from the Samsung Galaxy S smartphone, and was provided to us at the links below:
	https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 

The data set included raw sampled data of test & trains, features, features information and activity labels.
	There are three types of data:
    	1. X: they are features measurement 
    	2. Y: the activity labels 
    	3. subject: the subjects on which each row of X was measured.
	Features: list of features in dataset X
	Features information: interpreting what differnt features mean
	Activity_labels: interpreting what different activity number mean

Loading Data
	Load X,Y and Subject datasets from both train and test folders
	Only measurements with features names including keyword "mean" and "std" are selected
...
OutPut
	The final data table is written in the file "Getting_and_Cleaning_Data.txt"
